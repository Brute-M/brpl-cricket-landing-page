        ...
        <section className="py-24 bg-white relative overflow-hidden">
            <div className="container mx-auto px-4 relative z-10">
                ...
                >
                    ...
                    <p className="text-xl md:text-2xl font-bold italic text-gray-400 mt-2 uppercase tracking-[0.2em]">
                        (It's Simple)
                    </p>
                </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {steps.map((step, index) => (
                        ...
                        >
                            {/* Step Number Badge */}
                            <div className="absolute -top-6 left-1/2 -translate-x-1/2 w-12 h-12 bg-[#FF5C5C] text-white rounded-full flex items-center justify-center font-black text-xl shadow-lg border-4 border-white">
                                {index + 1}
                            </div>
                            ...
                            <div className="flex flex-col items-center text-center space-y-4">
                                ...
                                <h3 className="text-2xl font-black italic text-[#263574] uppercase tracking-tight">
                                    {step.title}
                                </h3>
                ...
                >
                    <button
                        ...
                        className="px-12 py-5 bg-gradient-to-r from-[#FACC15] to-[#f59e0b] text-black font-black italic text-xl md:text-2xl rounded-2xl shadow-[0_15px_35px_rgba(250,204,21,0.3)] uppercase tracking-wider transition-all duration-300 hover:scale-105 active:scale-95 flex items-center gap-4 mx-auto group"
                    >
